    ...
    <form class="text-gray-800" action="/events" method="POST">
      ...
      <div class="grid grid-cols-2 space-x-4 my-2">
        <div>
          ...
          <select name="event_theme" class="block appearance-none w-full bg-transparent border-gray-400 px-4 py-1 pl-2 pr-8 mt-1 mb-4 rounded-lg text-gray-100 text-sm" required>
